...
describe("Block markdown parsing", () => {
  ...
  it("parses a comprehensive research project description", () => {
    const md = `A 3-year systematic review of machine learning in cardiology.

### Research Goals
- Identify RCTs published between 2020 and 2026.
- Extract sensitivity and specificity metrics.
- Compare deep learning vs traditional risk scores.

### Methodology
1. Search MEDLINE, Embase, and IEEE.
2. Dual independent screening.
3. Automated consensus reconciliation.

For questions contact **Dr. Smith** via [OSF Project](https://osf.io/cardio) or \`drsmith@example.edu\`.`;
