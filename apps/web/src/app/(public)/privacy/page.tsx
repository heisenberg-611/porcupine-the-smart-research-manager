...
export const metadata: Metadata = {
  title: "Privacy Policy | porcupineResearch",
  ...
  return (
    <main className="mx-auto flex max-w-4xl flex-col gap-8 px-6 py-12 animate-in fade-in duration-500">
      ...
      <div className="prose max-w-none prose-p:leading-relaxed prose-p:mb-6 prose-p:text-muted prose-headings:text-ink prose-h2:text-2xl [&_h2]:text-2xl prose-h2:font-bold [&_h2]:font-bold prose-h2:text-accent [&_h2]:text-accent prose-h2:border-b [&_h2]:border-b prose-h2:border-rule [&_h2]:border-rule prose-h2:pb-2 [&_h2]:pb-2 prose-h2:mt-12 [&_h2]:mt-12 prose-h2:mb-6 [&_h2]:mb-6 prose-li:text-lg prose-li:my-4 prose-strong:text-lg prose-strong:font-bold prose-strong:text-ink [&_strong]:font-bold">
        ...
        <p>
          Some of porcupineResearch’s advanced features require you to supply us with information:
        </p>
        <ul>
          <li><strong>Account Information:</strong> We collect the information you voluntarily provide (e.g., your name and email address) when you create a porcupineResearch account.</li>
        ...
        <p>
          porcupineResearch employs a tiered encryption approach to ensure your data remains secure:
        </p>
        <ul>
        ...
        <p>
          When using third-party platforms, we request the most restrictive permissions available that still allow porcupineResearch to perform its advertised functions.
        </p>

        <h3>Google Workspace Integration</h3>
        <p>
          <strong>Restrictive Permissions:</strong> To provide seamless collaboration and identity verification, porcupineResearch integrates with Google Workspace and Google Authentication. When you connect your Google account, you grant porcupineResearch the following scopes: <strong><code>https://www.googleapis.com/auth/drive.file</code></strong>, <strong><code>email</code></strong>, and <strong><code>profile</code></strong>. The <code>drive.file</code> scope is a highly restrictive permission that only allows porcupineResearch to see, edit, create, and delete Google Docs and Sheets that the app <em>specifically created</em> or that you explicitly selected via the Google Picker. The <code>email</code> and <code>profile</code> scopes are used exclusively to securely identify you and create your account.
        </p>
        <p>
          <strong>Limited Use Policy:</strong> porcupineResearch <strong>cannot</strong> read your previous browsing history, nor can it access other files in your Google Drive. We push formatted claims, citations, and generated bibliographies into your documents to streamline your writing process. porcupineResearch’s use and transfer of information received from Google APIs to any other app will adhere to the <Link href="https://developers.google.com/terms/api-services-user-data-policy" target="_blank" className="text-accent hover:underline">Google API Services User Data Policy</Link>, including the Limited Use requirements.
        </p>

        <h2>Third-Party Services Used</h2>
        <p>
          <strong>Cloud Infrastructure:</strong> porcupineResearch server data is stored securely using cloud infrastructure provided by Vercel, Supabase, and Cloudflare.
        </p>
        <p>
          <strong>Metadata Retrieval:</strong> Certain operations you perform in porcupineResearch may trigger requests to public third-party services such as OpenAlex, Crossref, arXiv, or Semantic Scholar for metadata retrieval. These third parties may log your IP address and search terms (e.g., DOI) according to their privacy policies, but no other identifying personal information is provided.
        </p>
        ...
        <p>
          <strong>Right to Erasure:</strong> You may delete your porcupineResearch account at any time to remove the information you voluntarily provided when you registered and to remove the library data you synchronized with our servers.
        </p>
        ...
        <h2>Questions</h2>
        <p>
          <strong>Contact Us:</strong> If you have any questions or concerns regarding porcupineResearch’s privacy policies, please email <Link href="mailto:dhrubojyoti.saha@g.bracu.ac.bd" className="text-accent hover:underline">dhrubojyoti.saha@g.bracu.ac.bd</Link>.
        </p>
      </div>
    </main>
  );
