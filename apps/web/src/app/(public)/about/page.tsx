...
export const metadata: Metadata = {
  title: "How it works",
  description:
    "What each screen in porcupineResearch does, what it deliberately does not do, and what happens to your data.",
};
...
export default function AboutPage() {
  return (
    <main id="main" className="mx-auto max-w-3xl px-6 py-16 sm:py-20">
      {/* No back link. The site header above it is on every public page now,
          and its wordmark is the way home — a second one here would be a
          second entry in the link list going to the same place. */}
